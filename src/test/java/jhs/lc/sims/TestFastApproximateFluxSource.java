...
public class TestFastApproximateFluxSource {
	...
	public void testFluxArrayMatchesAngularOne() {
		...
		double[] flux1 = angularFluxSource.produceModeledFlux(peakFraction, brightnessSource, orbitRadius);
		...
		double[] flux2 = fastFluxSource.produceModeledFlux(peakFraction, brightnessSource, orbitRadius);
