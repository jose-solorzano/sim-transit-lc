...
public final class TriangularDistanceEstimator {
	...
	public final double triangularDistance(double[] point1Container, int point1Index, int length, double[] point2Container, int point2Index) {
		if(length == 0) {
			return 0;
		}
		double maxDistance = point2Container[point2Index] - point1Container[point1Index];
		int pivot = 0;
		for(int r = 0; r < length; r++) {
			...
			for(int i = 0; i < length; i++) {
				double direction = point1Container[point1Index + i] - point2Container[point2Index + i];
